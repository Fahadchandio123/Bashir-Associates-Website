...
export class Portfolio {
  ...
  projects: Project[] = [
    ...
    { id: 20, title: 'EMAAN SHOPPING MALL', category: 'commercial', images: ['assets/images/p-com.png'] },
    { id: 21, title: 'CLUB VIEW DUPLEX APARTMENTS', category: 'residential', images: ['assets/images/p-res.png'] },
